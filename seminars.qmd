...
The seminars consist of two activities. First, students **present** in groups of two or three a comparison of courts from multiple jurisdictions. Second we **discuss** the week's mandatory readings.
...
Students present in groups of two or three with each student covering **one specific court**. The chosen courts should preferably hold high importance in the judicial system of a country or international organization (e.g. peak courts). The presenting group concludes the presentation with a comparison of the selected courts. The full presentation should take 30 minutes in total.
...
Each court can only be covered **once** in a presentation. Students can 'reserve' courts for their presentation in the seminar of week 1. The choice of a court must be signalled in any case at least a week before the presentation is due (to enable other students to select their courts). There can be no repeat presentations of the same court.

## Readings

In each teaching week there is an assigned mandatory reading which students are expected to read and be prepared to discuss in class. There is also an additional list of optional readings which represent a good starting point to the literature on the topic of the week.
