...
The findings produced by the **empirical analysis** should be presented in a separate section for clarity. Thereafter they should be discussed in terms of the hypothesis, the research question and finally related back to the scholarly literature to which the paper is contributing. It is highly recommended to provide additional detail about the empirical analysis in an appendix for the sake of transparency.[^1]

[^1]: As a general rule, for qualitative methodology papers, this should be a transparency appendix ([example](https://dataverse.harvard.edu/file.xhtml?fileId=4887668&version=1.0)). For quantitative methodology papers, the appendix should clarify measurement choices and show robustness checks ([example](https://static.cambridge.org/content/id/urn%3Acambridge.org%3Aid%3Aarticle%3AS0007123425100884/resource/name/S0007123425100884sup001.pdf)). The appendix does not count towards the 3000-word limit. All essential information must be included in the paper, however.
