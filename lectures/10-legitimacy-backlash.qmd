...
-   before starting writing, make sure to:
    ...
    -   consult slides from previous weeks (eg week 7)
...
-   what are the determinants of public support of courts?
...
-   @gandur2025 show that this relationship is affected by the political context
    ...
    -   @micheli2024 similarly show that knowledge alone of Latin American courts does not increase trust
...
-   judges' identity categories operate as ideological cues affecting perceptions of judicial fairness [@bracic2023]

    -   marginalized identities increase Democrats' perceptions of fairness, impartiality and trust in SCOTUS

    -   Republicans see gay judges as less fair and impartial than straight judges

-   descriptive representation seems to matter little

    -   people prefer judges who (they assume) will think like them, not look like them
...
-   court rulings can (de)legitimize a policy [@sternberg2022]
    ...
    -   but courts might not be uniquely good at this [@cohen2024]

::: .notes
Cohen and Powers argue that compliance (with international law) signals from courts are not better at moving public opinion in the desired direction than signals from IOs or domestic elites
:::

## International courts and public opinion

-   support for international courts is context dependent

    -   which court, which country, which narratives [@zvobgo2025]

-   but generally tends to be correlated with trust in national courts and adjacent international organizations at the individual level [@stappert2025]

::: .notes
Zvobgo and Chaudoin (2025) do not find evidence that arguments about ICC's complementarity are convincing to global publics
:::
...
-   evidence of greater **self-restraint** in response to backlash
    ...
    -   the ECtHR rules less often against most critical governments [@stiansen2020]
